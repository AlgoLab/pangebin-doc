...
\begin{table}[h!]
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    \midrule
    \multicolumn{2}{@{}l@{}}{Constraints in \Cref{tab:decomp:mgc:cst}} \\
    \addlinespace
    \MPS{} dedicated & \Cref{pbf_iterbin:decomp:mps:cst:fix_mgc_obj} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{Constraint}
  \begin{equation}
    ...
    \cstlabel{pbf_iterbin:decomp:mps:cst:fix_mgc_obj} % chktex 25
  \end{equation}
\end{Constraint}
...
\begin{definition}{\MPS{} MILP objective function}{pbf_iterbin:decomp:mps:obj}
  ...
  \begin{Objective}
    \begin{equation}
      ...
      \objlabel{pbf_iterbin:decomp:mps:obj:max_plasmidness_score} % chktex 25 % chktex 35
    \end{equation}
  \end{Objective}
