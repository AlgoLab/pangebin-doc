...
\begin{figure}
  ...
  \figurecaption{Possible plasmid structures in a sequence graph.}{%
    ...
    We must constraint on the circularity: for each active oriented fragment, there is at least one incoming link and one outgoing link (without conting the source and the sink links).
    %
